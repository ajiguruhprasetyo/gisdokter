...
<style type="text/css">
  ...
  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA12GboM-guQYn9SyHbAi0Jao5Ih_uJE1E&callback=initMap"
          ...
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            $.ajax({
                ...
                success: function(msg){
                  for(i=0; i < msg.data.data_dokter.length;i++){
                    var point = new google.maps.LatLng(parseFloat(msg.data.data_dokter[i].lang_dok),parseFloat(msg.data.data_dokter[i].long_dok));
                    tanda = new google.maps.Marker({
                        position: point,
                        map: map,
                        icon: "place.png",
                        animation: google.maps.Animation.DROP,
                        title: msg.data.data_dokter[i].nama
                    });
                  }
                }
            });
...
<div class="container">
    <div class="row">
      <div class="col-lg-12">
        <legend><h3>Cari Praktek Dokter</h3></legend>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-9">
